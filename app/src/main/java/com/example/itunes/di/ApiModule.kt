...
fun provideHttpClient(): OkHttpClient {
    ...
    return OkHttpClient.Builder().readTimeout(60, TimeUnit.SECONDS)
        .connectTimeout(60, TimeUnit.SECONDS).addInterceptor(provideLoggingInterceptor()).build()
}
...
fun provideRetrofit(
    ...
    return Retrofit.Builder().baseUrl("https://itunes.apple.com/").client(okHttpClient)
